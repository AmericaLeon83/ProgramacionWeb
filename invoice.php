...
try {
    ...
    if (isset($_SESSION['cart'])) {
        ...
        // obtener el id del cliente a partir del correon
                ...
                if (isset($venta[0])) {
                    ...
                    if ($filasAfetadas) {
                        ...
                        if (isset($cliente[0])) {
                            ...
                            $mensaje = "Estimado $nombre, su compra ha sido realizada con éxito.<br>Agradecemos su preferencia.<br>Atentamente, Optica Los Angeles :3";
