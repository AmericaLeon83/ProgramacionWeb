...
<div id="myCarousel" class="carousel slide mb-6" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/armazones/armazonPublic.png" class="d-block w-100" alt="Imagen 1">
      <div class="container">
...
<div class="row mt-5 justify-content-center">
      <div class="col-12">
        <h2 class="page-header">¡Resalta tus mejores rasgos faciales con tu estilo de armazón favorito puesto! </h2>
...
<div class="container">
    ...
    <div class="product-block" data-productid="3514295">
        ...
        <div class="col-md-1 col-4 mb-3"> <!-- Cambio de col-md-auto a col-md-1 -->
            <div class="product-block" data-productid="3514295">
            <a href="#lentes_rectangulo"> <!-- Anchor para la primera imagen -->
                    <img class="product-image" src="images/armazones/RECTANGULO_CLIC.png" alt="Camara Nikon Reflex D7200 + Lente 18-140" />
                </a>
                <div class="caption text-left">
                    <div class="d-flex product-list-rating-container"></div>
                    <div class="clearfix"></div>
...
<div class="d-flex align-items-center justify-content-center">
    <img src="images/armazones/cuadrados.png" class="img-fluid" alt="Background Image">
</div>
  ...
  <div class="col-md-3 col-6">
    ...
    <div class="col-md-12">
      ...
      <div class="d-flex align-items-center justify-content-center">
      <img src="images/armazones/corazon.png" class="img-fluid" alt="Background Image">
    </div>
  ...
  <div class="col-md-3 col-6">
    ...
    <!--|||||LENTES CUERNO|||||||-->
    <div id="lentes_cuerno" class="row"> <!-- ID cambiado para que coincida con el enlace -->
    <div class="col-md-12">
    </div>
    </div>
      <div class="d-flex align-items-center justify-content-center">
      <img src="images/armazones/cuerno.png" class="img-fluid" alt="Background Image">
    </div>
    <div class="container">
  <!-- Latest Products -->
  <div class="row">
  ...
  <div class="col-md-3 col-6">
    ...
    <div class="col-md-12">
      ...
      <div class="d-flex align-items-center justify-content-center">
      <img src="images/armazones/ojodegato.png" class="img-fluid" alt="Background Image">
    </div>
  ...
  <div class="col-md-3 col-6">
    ...
    <!--|||||||LENTES POLIGONO||||||||-->
    <div id="lentes_poligono" class="row"> <!-- ID cambiado para que coincida con el enlace -->
    <div class="col-md-12">
    </div>
    </div>
      <div class="d-flex align-items-center justify-content-center">
      <img src="images/armazones/poligono.png" class="img-fluid" alt="Background Image">
    </div>
  ...
  <div class="col-md-3 col-6">
    ...
    <!--~~~~~~~~~~FIN DE LENTES POLIGONO~~~~~~~~~~~~-->
     <!--|||||LENTES REDONDO|||||||-->
     <div id="lentes_redondo" class="row"> <!-- ID cambiado para que coincida con el enlace -->
    <div class="col-md-12">
    </div>
     </div>
      <div class="d-flex align-items-center justify-content-center">
      <img src="images/armazones/redondo.png" class="img-fluid" alt="Background Image">
    </div>
  ...
  <div class="col-md-3 col-6">
    ...
    <div class="col-md-12">
      ...
      <div class="d-flex align-items-center justify-content-center">
      <img src="images/armazones/aviador.png" class="img-fluid" alt="Background Image">
    </div>
