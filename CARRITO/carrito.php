...
if(isset($_GET['id']) && is_numeric($_GET['id'])){
    ...
    $producto = new Kawschool\Producto; // Cambio de "Pelicula" a "Producto"
    $resultado = $producto->mostrarPorId($id); // Cambio de "Pelicula" a "Producto"
    ...
    if(isset($_SESSION['carrito'])){ // SI EL CARRITO EXISTE
        ...
        if(array_key_exists($id,$_SESSION['carrito'])){
            actualizarProducto($id); // Cambio de "Pelicula" a "Producto"
        }else{
            // SI EL PRODUCTO NO EXISTE EN EL CARRITO
            agregarProducto($resultado, $id); // Cambio de "Pelicula" a "Producto"
        }
    ...
    <div class="container" id="main">
            <table class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Producto</th> <!-- Cambio de "Pelicula" a "Producto" -->
                      <th>Foto</th>
                      <th>Precio</th>
                      <th>Cantidad</th>
                      <th>Total</th>
