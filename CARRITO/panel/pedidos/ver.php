      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            ...
            <li>
              <a href="../productos/index.php" class="btn">Productos</a> <!-- Cambiar de peliculas a productos -->
            </li>
            <li class="dropdown">
          ...
          <div class="col-md-12">
            <fieldset>
                ...
                <div class="form-group">
                    <label>Nombre</label>
                    <input value="<?php print $info_pedido['nombre_cliente'] ?>" type="text" class="form-control" readonly>
                </div>
                <div class="form-group">
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      <th>#</th>
                      <th>Nombre</th> <!-- Cambiar de Título a Nombre -->
                      <th>Foto</th>
                      <th>Precio</th>
                      <th>Cantidad</th>
                      <th>
                  ...
                  <tbody> 
                    ...
                    <tr>
                      <td><?php print $c?></td>
                      <td><?php print $item['nombre_producto']?></td> <!-- Cambiar de titulo a nombre -->
                      <td>
                      <?php
